...
/**
 * Class to represent the result of the NuGet process execution
 */
public class Result {
     ...
     * @param success Whether or not the NuGet process completed successfully
     * @param message The message to communicate back as the result of the NuGet execution
     */
     ...
     * @param success Whether or not the NuGet process completed successfully
     * @param message The message to communicate back as the result of the NuGet execution
     * @param exception The exception that the NuGet execution encountered
     */
